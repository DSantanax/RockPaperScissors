...
public class Tournament {
    public static void main(String[] args) {
        ...
        //add players to list
        List<Player> arrayListPlayers = new ArrayList<>(Arrays.asList(players));


        WinnerThread winThread = new WinnerThread(arrayListPlayers, numberOfPlayer);
        winThread.StartGame();

     //  System.out.println("Winner is: " + arrayListPlayers.get(0).getPlayerNumber());
    }
}
